...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_DIAGONAL_ROD 288.46 // mm
      // Horizontal offset from middle of printer to smooth rod center.
    #define DELTA_SMOOTH_ROD_OFFSET 163 // mm
    // Horizontal offset of the universal joints on the end effector.
    #define DELTA_EFFECTOR_OFFSET 42.35 // mm
    // Horizontal offset of the universal joints on the carriages.
    #define DELTA_CARRIAGE_OFFSET 0.00 // mm
  ...
  #define DELTA_HEIGHT 258.8 // get this value from auto calibrate
...
#define Z_PROBE_LOW_POINT          -60 // Farthest distance below the trigger-point to go before stopping
...
#define HOMING_FEEDRATE_Z  (250*60)
