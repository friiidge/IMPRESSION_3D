 ...
 */
#define E0_STEPS      88.3 // Stock value, still needs to be calibrated for your extruder stepper
...
#define SENSOR_LEFT        40  // If your X offset is Negative type it here without the minus (-) Example if -46 then type 46 
