...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 262.0 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 295.7 // get this value from auto calibrate
...
#define BLTOUCH
#if ENABLED(BLTOUCH)
  //#define BLTOUCH_DELAY 400   // (ms) Enable and increase if needed
#endif
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER -27.2   // Y offset: -front +behind [the nozzle]
